					...
					<div class="col-md-4">
						<div class="banner_item align-items-center" style="background-image:url(images/banner_1.jpg)">
							<div class="banner_category">
								<a href="categories.php?catName=Thời%20trang%20nữ">women's</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="banner_item align-items-center" style="background-image:url(images/banner_2.jpg)">
							<div class="banner_category">
								<a href="categories.php?catName=Phụ%20kiện">accessories's</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="banner_item align-items-center" style="background-image:url(images/banner_3.jpg)">
							<div class="banner_category">
								<a href="categories.php?catName=Thời%20trang%20nam">men's</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col text-center">
						<div class="new_arrivals_sorting">
							<ul class="arrivals_grid_sorting clearfix button-group filters-button-group">
								...
								<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".2">women's</li>
								<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".7">accessories</li>
								<li class="grid_sorting_button button d-flex flex-column justify-content-center align-items-center" data-filter=".1">men's</li>
							</ul>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col">
						<div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
							...
							// Thực hiện truy vấn lấy dữ liệu từ bảng sản phẩm
							$sql = "
							SELECT p.*
							FROM product p
							JOIN category c ON p.catId = c.catId
							WHERE c.catName IN ('Thời trang nam', 'Thời trang nữ', 'Phụ kiện')
							AND (
								SELECT COUNT(*) 
								FROM product p2 
								WHERE p2.catId = p.catId AND p2.productId <= p.productId
							) <= 5 AND hidden = 0;
							";
							...
							if (mysqli_num_rows($result) > 0) {
								while ($row = mysqli_fetch_assoc($result)) {
									...
									echo '<div class="product_price">$' . $row['price_discount'] . '<span>' . $row['price'] . '</span>' . '</div>';
									echo '</div>';
									echo '</div>';
